...
class App(customtkinter.CTk):
    ...
    def search_event(self, event=None):
        ...
        print(self.results.dijkstra_time)
        print(self.results.dijkstra_time_unit)
        print(self.results.dijkstra_path)
        print(self.results.dijkstra_direct_flights)
        print(self.results.dijkstra_connecting_flights)
        print(self.results.a_star_time)
        print(self.results.a_star_time_unit)
        print(self.results.a_star_path)
        print(self.results.a_star_direct_flights)
        print(self.results.a_star_connecting_flights)
